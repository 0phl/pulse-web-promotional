      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Button size="sm" onClick={() => window.open('https://app.appsonair.com/install/TX1FpB0W', '_blank')}>
              Download App
            </Button>
          </nav>
        ...
        {isMobileMenuOpen &&
          <motion.div
            ...
            <div className="px-4 py-6 space-y-4">
              ...
              <Button fullWidth onClick={() => window.open('https://app.appsonair.com/install/TX1FpB0W', '_blank')}>
                Download App
              </Button>
            </div>
          </motion.div>
